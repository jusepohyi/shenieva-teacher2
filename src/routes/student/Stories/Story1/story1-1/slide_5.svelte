<script>
    ...
    const QUESTION_ID = 'story1_q1'; // Unique identifier for this question
    let selectedAnswer = '';
    ...
    onMount(() => {
        // If desired, clear the flag on the last question slide instead of here
...
<div class="flex flex-col justify-center items-center text-center slide">
    ...
    <div class="question-container text-fade">
        ...
        <p class="text-[2.5vw] md:text-lg mb-6">1. What do you think Lena will do next based on her actions?</p>
        ...
        <div class="options-container">
            <label class="option" class:disabled={isAnswered} class:selected={selectedAnswer === 'a'}>
                ...
                <span class="text-[2vw] md:text-base">a. Refuse to let Maria take the items until she pays.</span>
            </label>
            ...
            <label class="option" class:disabled={isAnswered} class:selected={selectedAnswer === 'b'}>
                ...
                <span class="text-[2vw] md:text-base">b. Let Maria take the items and pay later, trusting her.</span>
            </label>
            ...
            <label class="option" class:disabled={isAnswered} class:selected={selectedAnswer === 'c'}>
                ...
                <span class="text-[2vw] md:text-base">c. Ask Maria to leave and come back when she has a change for her money.</span>
            </label>
        </div>
