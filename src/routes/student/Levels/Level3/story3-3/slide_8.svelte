<script lang="ts">
    ...
    const q1 = 'story3-3_q1';
    const q2 = 'story3-3_q2';
    const q3 = 'story3-3_q3';
    ...
    function handleInput() {
        console.log('story3-3 handleInput called:', { a1, a2, a3, isLevelCompleted });
            ...
            studentData.update((data: any) => {
                ...
                const updated = {
                    ...
                    answeredQuestions: {
                        ...
                        [q2]: a2,
                        [q3]: a3,
                        ['story3-3_finalized']: false
                    }
                };
                console.log('story3-3 updating store with:', updated.answeredQuestions);
                return updated;
            });
        }
    }
  ...
  <div class="quiz-card">
    ...
    <div class="qa">
      <label class="question" for="q1">
        1. Based on his actions, how does Liloy feel when Lingling is nowhere to be found?
      </label>
      <textarea
        id="q1"
        class="answer"
    ...
    <div class="qa">
      <label class="question" for="q2">
        2. What do you think Liloy will do next?
      </label>
      <textarea
        id="q2"
        class="answer"
