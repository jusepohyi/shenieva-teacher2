<script lang="ts">
    ...
    function handleInput() {
        console.log('story3-1 handleInput called:', { a1, a2, a3, isLevelCompleted });
            ...
            studentData.update((data: any) => {
                ...
                const updated = {
                    ...
                    answeredQuestions: {
                        ...
                        [q2]: a2,
                        [q3]: a3,
                        ['story3-1_finalized']: false
                    }
                };
                console.log('story3-1 updating store with:', updated.answeredQuestions);
                return updated;
            });
        }
    }
